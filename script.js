function getCardData() {
    ...
    fetch(
      "https://smartcard.saksiam.co.th:8182/thaiid/read.jsonp?callback=callback&section1=true&section2a=true&section2b=true&section2c=true",
      {
        method: "GET",
        mode: "cors",
        credentials: 'include',
      ...
      .then((data) => {
        ...
        if (obj == null) {
          ...
          var expDate = getFormatedDateOfBirth(obj.ExpiryDate); //วันหมดอาุยุบัตร
          ...
          document.getElementById(
            "16a404c4-756e-eac5-49ef-49708eb66b2d_c9e08b1b-561b-b643-7e5b-8b17ea18c2a9"
          ).value = obj.FirstNameTh;
          document.getElementById(
            "16a404c4-756e-eac5-49ef-49708eb66b2d_ab669fbf-e964-4cce-b904-498fcbe9762c"
          ).value = obj.LastNameTh;
          document.getElementById(
            "16a404c4-756e-eac5-49ef-49708eb66b2d_ee635376-333b-2191-c035-288e2f1fd500"
          ).value = expDate;
          document.getElementById(
